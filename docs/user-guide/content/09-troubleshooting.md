...
### Feedback
Use the in-app feedback form to report issues or suggestions. Your email is encrypted for privacy. You can also join the [HamTab Discord server](https://discord.gg/Ru3ydQY75U) for real-time community discussion and support.
